...
const Footer = () => {
  return (
    <footer className="bg-agency-dark text-white pt-16 pb-8">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="mb-6">
              <a href="#" className="text-2xl font-bold flex items-center">
                <span className="text-agency-purple">NEXUS</span>
                <span className="ml-1 text-white">DIGITAL</span>
              </a>
              <p className="mt-4 text-gray-400">
                We leverage AI and data-driven strategies to help businesses thrive in the digital landscape.
              </p>
            </div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <ArrowRight className="w-4 h-4 mr-2 text-agency-purple" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#case-studies" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <ArrowRight className="w-4 h-4 mr-2 text-agency-purple" />
                  Case Studies
                </a>
              </li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter to receive updates and marketing insights.
            </p>
            <form className="flex">
              <input 
                type="email" 
              ...
              <button 
                type="submit" 
                className="bg-agency-purple hover:bg-agency-purple/80 text-white py-3 px-4 rounded-r-lg transition-colors"
              >
